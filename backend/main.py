...
from routers import auth, llm, search, web_retrieval, general_chat, conversations, memories, assets, profile, tools, oauth, agents, table, workflows, job_mandate
...
app.include_router(job_mandate.router)
